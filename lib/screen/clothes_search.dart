          ...
          children: [
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (value) => searchController.searchClothes("3", value),
                    ...
                    return InkWell(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text('Price: ${item['standerd_price'] ?? 'N/A'}'),
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Get.to(BookingScreen(selectedClothes: selectedClothes, userId: widget.userId,));
                  },
                  child: Text('Proceed to Next Page (${selectedClothes.length})'),
                ),
              ),
          ],
        ),
