import 'dart:convert';
import 'package:fabspinrider/src/presentation/screen/image_upload_screen.dart';
                      ...
                      children: [
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            print(
                                "Booking Item: $bookingItem"); // Debug point added
                            ...
                            return Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${bookingItem['servicename']} - ${bookingItem['subtradename']} - ${bookingItem['clothname']}",
